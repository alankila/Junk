...
public class MatrixUtil {
	 ...
	 * same number of rows as columns. That the resulting equation is the
	 * least squares approximate follows from the fact that difference
	 * between candidate solution a*x and b must be a vector in the orthogonal
	 * space of the column space of a, which must be a^T's null space, and
	 * that therefore the least squares solution must be a^T (Ax - b) = 0.
	 * 
	 * @param a the n*m matrix
	 * @param b the n*1 vector
	 * @return x the m*1 vector
